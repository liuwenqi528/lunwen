...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function (exports) {
    ...
    var $ = layui.$
        ...
        , TPL_HEADER = function (options) {
            ...
            return ['<table cellspacing="0" cellpadding="0" border="0" class="layui-table" '
                ...
                , '<th data-field="{{ item2.field||i2 }}" {{# if(item2.minWidth){ }}data-minwidth="{{item2.minWidth}}"{{# } }} ' + rowCols + ' {{# if(item2.unresize){ }}data-unresize="true"{{# } }}  class="laytable-cell-'
                , '{{# if(item2.colspan > 1){ }}'
                , 'group'
                , '{{# } else { }}'
    ...
    Class.prototype.setArea = function () {
        ...
        layui.each(options.cols, function (i1, item1) {
            layui.each(item1, function (i2, item2) {
                ...
                if (item2.colspan > 1) return;
                if (item2.width === 0) {
                    item2.width = autoWidth >= minWidth ? autoWidth : minWidth; //不能低于设定的最小宽度
                }
            });
        });
                ...
                layui.each(data, function (i1, item1) {
                    ...
                    that.eachCols(function (i3, item3) {
                        ...
                        var td = ['<td data-field="' + field + '" ' + function () {
                            ...
                            attr.push('class="laytable-cell-' + function(){
                            ...
                            , '<div class="layui-table-cell">' + function () {
    ...
    Class.prototype.events = function () {
        var that = this
            ...
            , clientWidth = that.layHeader.width()
            , resizing
        ...
        _DOC.on('mousemove', function (e) {
            if (dict.resizeStart) {
                ...
                if (dict.rule) {
                    ...
                    dict.rule.style.width = parseFloat(setWidth/clientWidth)*100 + '%';
                    layer.close(that.tipsIndex);
                }
                resizing = 1
            }
