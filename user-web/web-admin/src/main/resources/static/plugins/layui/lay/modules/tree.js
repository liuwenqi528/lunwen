...
layui.define("jquery", function (e) {
    ...
    i.prototype.traverseModel = function (treeTable, parentNode, item, childrenAttrs) {
        ...
        var o = this;
        var tableHeaderStr = '<thead><tr><th style="width:40px"></th>';
        for (var ind = 0; ind < o.options.layout.length; ind++) {
            ...
            var style = o.options.layout[ind].style ? 'style ="' + o.options.layout[ind].style + '"' : '';
            tableHeaderStr += '<th' + headerClass + ' ' + style + ' data-field="' + o.options.layout[ind].field + '"><div class="layui-table-cell laytable-cell-1-' + o.options.layout[ind].field + '"><span>' + o.options.layout[ind].name + '</span></div></th>';
        }
        ...
        o.options.skin && e.addClass("layui-tree-skin-" + o.options.skin),
            ...
            e.wrapInner('<div class="layui-form layui-table-view"></div>'),
            o.on(e);
        index = 1;
        return e;
