        ...
        if (_36b.type == "all" || _36b.type == "header") {
            ...
            if (opts.header) {
                ...
                if (opts.closable) {
                    ...
                    $("<a href=\"javascript:;\" class=\"tabs-close iconfont icon icon-guanbi\"></a>").appendTo(tab);
                } else {
...
(function ($) {
    function init(_489) {
        var _48a = $("<span class=\"switchbutton\">" + "<span class=\"switchbutton-inner\">" + "<span class=\"switchbutton-on\"></span>" + "<span class=\"switchbutton-handle\"></span>" + "<span class=\"switchbutton-off\"></span>" + "<label><input class=\"switchbutton-value\" type=\"checkbox\"><i class=\"iconfont icon-touming\"></i></label>" + "</span>" + "</span>").insertAfter(_489);
        var t = $(_489);
...
(function ($) {
    ...
    function _500(_501, _502) {
        ...
        if (opts.height == "auto") {
            _506.css({margin: "", paddingTop: "", paddingBottom: "", height: "22px", lineHeight: "22px"});
        }
        tb._size(opts, _504);
...
(function ($) {
            ...
            for (var i = 0; i < _69a.length; i++) {
                ...
                for (var j = 0; j < cols.length; j++) {
                    ...
                    if (col.checkbox) {
                        ...
                        $("<div class=\"datagrid-header-check\"></div>").html("<label><input type=\"checkbox\" /><i class=\"iconfont icon-touming\"></i></label>").appendTo(td);
                    } else {
                        if (col.field) {
                            td.attr("field", col.field);
    ...
    function _6c4(e) {
        ...
        var _6c6 = _6c2(tr);
        var tt = $(e.target);
        if (tt.parent().parent().hasClass(".datagrid-cell-check")) {
            if (opts.singleSelect && opts.selectOnCheck) {
                tt._propAttr("checked", !tt.is(":checked")).next()._propAttr("class", !tt.is(":checked") ? "iconfont icon-touming" : "iconfont icon-o3").css({backgroundColor: !tt.is(":checked") ? '' : '#5FB878'});
                _6c7(_6c5, _6c6);
            } else {
                if (tt.is(":checked")) {
                    tt._propAttr("checked", false).next()._propAttr("class", "iconfont icon-touming").css({backgroundColor: ''});
                    _6c7(_6c5, _6c6);
                } else {
                    tt._propAttr("checked", true).next()._propAttr("class", "iconfont icon-o3").css({backgroundColor: '#5FB878'});
                    _6c8(_6c5, _6c6);
                }
            }
        } else {
    ...
    function _6c7(_75f, _760, _761) {
        ...
        tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked", true).next()._propAttr("class", "iconfont icon-o3").css({backgroundColor: '#5FB878'});
        tr = opts.finder.getTr(_75f, "", "checked", 2);
        if (tr.length == opts.finder.getRows(_75f).length) {
            var dc = _762.dc;
            dc.header1.add(dc.header2).find("input[type=checkbox]")._propAttr("checked", true).next()._propAttr("class", "iconfont icon-o3").css({backgroundColor: '#5FB878'});
        }
        if (opts.idField) {
    ...
    function _6c8(_763, _764, _765) {
        ...
        tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked", false).next()._propAttr("class", "iconfont icon-touming").css({backgroundColor: ''});
        var dc = _766.dc;
        var _767 = dc.header1.add(dc.header2);
        _767.find("input[type=checkbox]")._propAttr("checked", false).next()._propAttr("class", "iconfont icon-touming").css({backgroundColor: ''});
        if (opts.idField) {
    ...
    function _6b5(_768, _769) {
        ...
        hck.add(bck)._propAttr("checked", true).next()._propAttr("class", "iconfont icon-o3").css({backgroundColor: '#5FB878'});
        if (opts.idField) {
            for (var i = 0; i < rows.length; i++) {
    ...
    function _6b6(_76b, _76c) {
        ...
        hck.add(bck)._propAttr("checked", false).next()._propAttr("class", "iconfont icon-touming").css({backgroundColor: ''});
        if (opts.idField) {
            for (var i = 0; i < rows.length; i++) {
    ...
    var _7de = $.extend({}, _7d0(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            ...
            init: function (_7e7, _7e8) {
                var _7e9 = $("<label><input type=\"checkbox\" /><i class=\"iconfont icon-touming\"></i></label>").appendTo(_7e7);
        ...
        render: function (_828, _829, _82a) {
            ...
            for (var i = 0; i < _839.length; i++) {
                ...
                if (col) {
                    ...
                    cc.push(">");
                    if (col.checkbox) {
                        cc.push("<label><input type=\"checkbox\" " + (_83c.checked ? "checked=\"checked\"" : ""));
                        cc.push(" name=\"" + _83e + "\" value=\"" + (_83f != undefined ? _83f : "") + "\"><i class=\"iconfont " + (_83c.checked ? "icon-o3" : "icon-touming") + "\"></i></label>");
            ...
            for (var i = 0; i < _9b1.length; i++) {
                ...
                if (col) {
                    ...
                    if (col.checkbox) {
                        ...
                        cc.push(" name=\"" + _9b5 + "\" value=\"" + (row[_9b5] != undefined ? row[_9b5] : "") + "\"><i class=\"iconfont ");
                        if (row.checked) {
                            cc.push("icon-o3\"");
                        } else {
                            cc.push("icon-touming\"");
                        }
                        cc.push("></i></label>");
                    } else {
                        var val = null;
